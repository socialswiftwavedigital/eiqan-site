...
export const valuesAr = [
  {
    title: "السلامة أولاً",
    description:
      "كل قرار نتخذه — من تصميم المسار إلى المراقبة داخل المركبة — ينطلق من سلامة من ننقلهم.",
  },
  {
    title: "تميّز تشغيلي",
    description:
      "نجمع بين مشغلي نقل ذوي خبرة وعمليات منضبطة لضمان انطلاق كل رحلة في وقتها، دائماً.",
  },
  {
    title: "مدفوع بالذكاء الاصطناعي",
    description:
      "تقنيتنا مطوّرة داخلياً لرصد المخاطر وتحسين المسارات وأتمتة التقارير قبل تفاقم المشكلات.",
  },
  {
    title: "شفافية تامة",
    description:
      "يعرف أولياء الأمور والإداريون وملاك الأساطيل دائماً أين يتواجد أفرادهم وكيف يسير أداء الخدمة.",
  },
];
...
export const faqsAr = [
  {
    question: "ما هي إيقان؟",
    answer:
      "إيقان مزوّد خدمة نقل مدعوم بالتقنية، يقدم نقلاً آمناً وشفافاً ومراقباً بالذكاء الاصطناعي للمدارس والشركات ومشغلي الحافلات حول العالم.",
  },
  {
    question: "كيف تعمل مراقبة السلامة بالذكاء الاصطناعي لدى إيقان؟",
    answer:
      "يحلّل الذكاء الاصطناعي أنظمة الكاميرات والصوت داخل المركبة باستمرار لرصد الأحداث والسلوكيات غير الآمنة لحظياً، وتنبيه فريق العمليات فوراً للاستجابة السريعة عند حدوث أي مشكلة.",
  },
  {
    question: "هل تخدمون مشغلي التأجير والأساطيل؟",
    answer:
      "نعم. تعمل إيقان مع مشغلي تأجير الحافلات وملاك الأساطيل لتوفير الالتزام والتتبع اللحظي وإدارة السائقين والتقارير التشغيلية لأساطيلهم — سواء لمسارات مدرسية أو نقل موظفين أو رحلات تأجير.",
  },
  {
    question: "في أي دول تعمل إيقان؟",
    answer:
      "صُممت إيقان للعمل عالمياً وهي في توسع مستمر عبر أسواق متعددة. تواصل معنا لمناقشة التوفر في منطقتك.",
  },
  {
    question: "كيف يتتبع أولياء الأمور حافلة أبنائهم؟",
    answer:
      "يتلقى أولياء الأمور تحديثات مباشرة عبر GPS، وتنبيهات وقت الوصول، وإشعارات الصعود والنزول من خلال تطبيق أولياء الأمور. كما يمكنهم مشاهدة بث الكاميرا المباشر أثناء تواجد طفلهم في الحافلة.",
  },
  {
    question: "ما الفرق بين نقل الطلاب وخدمة نقل الموظفين؟",
    answer:
      "يُبنى نقل الطلاب حول رؤية أولياء الأمور والحضور الرقمي وضوابط حماية صارمة، بينما تركّز خدمة نقل الموظفين على تسجيل دخول الموظفين والمسارات حسب الورديات وتقارير مكان العمل. تعمل الخدمتان على نفس منصة إيقان، بإعدادات مخصصة لكل حالة استخدام.",
  },
  {
    question: "هل يمكنني طلب عرض سعر مخصص لمؤسستي؟",
    answer:
      "نعم. يُحدَّد نطاق كل تنفيذ وفق حجم أسطولك ومساراتك ومتطلباتك. املأ نموذج التواصل أو راسلنا عبر واتساب وسنرد خلال 24 ساعة بعرض سعر مخصص.",
  },
];
